...
.doctorpg-tab-mainbox .slick-active.active {
    background-color: <?=Session::get('main_color')?> !important;
    border: 1px solid <?=Session::get('main_color')?> !important;
    color: <?=Session::get('text_color')?> !important;
}
...
.chats-tab-open .contacts-list .contacts-item.active .avatar::before {
	border-color: <?=Session::get('main_color')?> !important;
}
/*.slick-track{
	transform: translate3d(0px, 0px, 0px)!important;
} */
</style><?php /**PATH E:\freelance laravel\helping-hand\resources\views/front/cssclass.blade.php ENDPATH**/ ?>