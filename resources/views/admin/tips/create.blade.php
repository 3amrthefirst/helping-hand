         ...
         <div class="col-md-9">
            <div class="card">
               <div class="card-body">
                  ...
                  @endif
                  <form action="{{url('admin/tips/store')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                     {{csrf_field()}}
{{--                     <input type="hidden" name="id" id="id" value="{{$department_id}}"/>--}}
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="name" placeholder="{{__('messages.Enter') }} Title" class="form-control" required name="name" value="{{ isset($data->name)?$data->name:''}}">
                     </div>
                     <div class="form-group">
